...
export async function classifyAndDraft(input: {
  ...
  const userTurn = `The following is an inbound email to info@oxxovo.com. Answer it as the OXXOVO Help Assistant, in the sender's language, using only the knowledge base. If you cannot answer from the knowledge base, use the standard "contact info@oxxovo.ai" reply.
