...
export type Messages = {
  ...
  watch: {
    ...
    // HQ 2026-08-22, item 3: audience needs to know the required element
    // (main_round_twist, EN "Twist" / KO "필수조건") to judge how well an
    // entry solved it -- community vote is half the main-round score.
    // Gated on isTwistRevealed() server-side (never rendered before reveal
...
const MESSAGES_EN: Messages = {
  ...
  application_detail: {
    ...
    scoring_originality: 'Originality',
    scoring_integrity_weight: 'Integrity',
...
const MESSAGES_KO: Messages = {
  ...
  application_detail: {
    ...
    scoring_intent: '의도',
    scoring_execution: '실행',
    scoring_originality: '독창성',
    scoring_integrity_weight: '진정성',
