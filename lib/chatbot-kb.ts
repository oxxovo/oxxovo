...
- KR: 선착순 100명 한정으로 — 1년 무료 멤버십, Founding 배지, 영구 아카이브 등재가 제공됩니다.
- EN: Limited to the first 100 — a 1-year free membership, a Founding badge, and permanent archive recognition.
...
- Founding Creator benefits beyond the stated three (1-year free membership, badge, archive) -- undecided, do not assert.
