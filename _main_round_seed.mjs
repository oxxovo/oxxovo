...
const MAPPING = [
  ...
  // 2.0 lumea (hand+cream-application physics breakthrough), 720p/15s/portrait.
  // Audio condition-matched: cf_01_lumea's music muxed onto the silent Seedance
  // (video copied, breakthrough footage intact) so scoring isn't confounded by
  // silence. Deliberate quality-gap probe: does Triple-AI rank the better film #1? (TK 2026-07-13)
  { appId: '75173f4c-961c-419c-981d-8d7011743ec1', url: 'https://pub-bf4080d3cdcd422dbef5b1a7f2b9e19a.r2.dev/cf/v3/cf_01_lumea_seedance_15s.mp4' },   // Frame & Muse (Seedance 2.0 + audio)
