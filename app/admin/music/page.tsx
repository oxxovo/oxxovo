...
// studio_music_assets has 0 rows and no score column exists in either repo, so
// today this page renders an honest empty state naming the two things it is waiting
// for. It is built now because `active` is the one participant-facing switch on the
// path and it is orthogonal to both pending inputs (the grid values and the score).
//
